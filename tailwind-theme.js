// tailwind-theme.js
// Wait for Tailwind to be available, then apply theme config
(function() {
    const applyConfig = () => {
        if (typeof tailwind === 'undefined') {
            // Tailwind not ready yet, retry after a short delay
    ...
    // Try to apply immediately, or wait for Tailwind CDN to load
    applyConfig();
})();
